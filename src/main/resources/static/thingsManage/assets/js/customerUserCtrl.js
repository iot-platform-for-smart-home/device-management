mainApp.controller("customerUserCtrl",["$scope","$resource",function ($scope,$resource) {
    ...
    // var userObj = $resource("/api/account/showAllCustomer");
    // $scope.userInfo = userObj.query();
