...
$(document).ready(function () {
    ...
    if(lang_flag==1){
        ...
        document.getElementById("userCustGroupID").innerText="客户ID：";
        document.getElementById("userTenantID").innerText="E-mail：";
        document.getElementById("userEmail").innerText="联系方式：";
        // document.getElementById("userPrivilegeLevel").innerText="权限等级：";
        document.getElementById("userNote").innerText="地址：";
        ...
        document.getElementById("userCustGroupID").innerText="Customer ID：";
        document.getElementById("userTenantID").innerText="E-mail：";
        document.getElementById("userEmail").innerText="Phone：";
        // document.getElementById("userPrivilegeLevel").innerText="Privilege Level：";
        document.getElementById("userNote").innerText="Address：";
